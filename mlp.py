...
X_train_np = np.load("features_all_train_BERTweet.npy")
X_train = torch.tensor(X_train_np, dtype=torch.float32)
y_train = np.load("labels_train_BERTweet.npy")



X_test_np = np.load("features_all_test_BERTweet.npy")
X_test = torch.tensor(X_test_np, dtype=torch.float32)
y_test = np.load("labels_test_BERTweet.npy")

print("for BERTweet, MLP tuning")
